# Abhinay IIIT Pune Website Migration - Executive Summary

This document summarizes the transition of the Abhinay IIIT Pune website from a static, hardcoded Next.js site to a fully dynamic, database-driven application hosted on cPanel.
